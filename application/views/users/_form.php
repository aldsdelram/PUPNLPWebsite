...
//	session_start ();
	...
	if($page == 'register'){
		...
		echo "<input class='form-control' name='username' type='text' placeholder='username' value='".(empty($_POST["username"])?"":$_POST["username"])."' disabled />\n";
		echo $newline;

		echo "<label> New Password </label> <i>Leave it blank if you won't update your password.</i>";
		echo "<input class='form-control' name='password_update' type='password' />";
		echo $newline;

		echo "<label> Confirm New Password </label>";
		echo "<input class='form-control' name='password_new_update' type='password' />";
		echo $newline;
	}
	...
	if($page == 'register'){
		...
		echo "<label> Confirm Password </label>";
		echo "<input class='form-control' name='password_confirm_update' type='password' />";
		echo $newline;

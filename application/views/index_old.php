...
<head>
    ...
    <!-- Custom CSS -->
    <link href="/public/stylesheets/stylish-portfolio.css" rel="stylesheet">
...
<!--                     <ul class="list-inline">
 ...
 -->                    <hr class="small">
                    <p class="text-muted">Copyright &copy; NLP Tools 2016</p>
                </div>
            </div>
        </div>
    </footer>
